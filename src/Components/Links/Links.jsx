...
const socialLinks = [
  {
    name: "LeetCode",
    link: "https://leetcode.com/u/abhiram_paidimarri/",
    svg: (
      <svg
        className="sm:w-10 sm:h-10 md:w-12 md:h-12 w-16 h-16 lg:h-16 lg:w-16 fill-current"
  ...
  {
    name: "GitHub",
    link: "https://github.com/Abhiram-23",
    svg: (
      <svg
        className="sm:w-10 sm:h-10 md:w-14 md:h-14 w-16 h-16 lg:h-16 lg:w-16 fill-current"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/abhirampaidimarri/",
    svg: (
      <svg
        width="800px"
        height="800px"
  ...
  {
    name: "HackerRank",
    link: "https://www.hackerrank.com/profile/pabhi2000",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        ...
        {socialLinks.map(({ name, link, svg }) => (
          <div key={name}>
            <a href={link} target="_blank" rel="noopener noreferrer">
              <div className="cursor-pointer list-none text-center">
                {svg}
                <h1 className="text-sm sm:text-sm md:text-lg">{name}</h1>
              </div>
            </a>
          </div>
        ))}
